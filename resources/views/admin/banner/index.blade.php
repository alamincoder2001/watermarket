...
@section("breadcrumb_title", "Banner")
@section("breadcrumb_item", "Banner Create")
...
<script>
    ...
    var table = $('#datatable').DataTable({
        ajax: location.origin + "/admin/banner/fetch",
        order: [[ 0, "desc" ]],
        columns: [{
                data: 'id',
            },
    ...
    function Store(event) {
        ...
        $.ajax({
            url: location.origin + "/admin/banner",
            method: "POST",
            data: formdata,
            processData: false,
            contentType: false,
    ...
    function Edit(id) {
        ...
        $.ajax({
            url: location.origin + "/admin/banner/fetch/" + id,
            method: "GET",
            dataType: "JSON",
            success: res => {
    ...
    function Delete(id) {
        if (confirm("Are you sure want delete this !")) {
            $.ajax({
                url: location.origin + "/admin/banner/delete/",
                method: "POST",
                data: {
                    id: id
                },

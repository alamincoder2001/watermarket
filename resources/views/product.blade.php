                            ...
                            <form action="#">
                                ...
                                <div class="widget-inner">
                                    <div class="widget-check-box">
                                        ...
                                        <label for="20824">Baking & Pastry Mats (12)</label>
                                    </div>
                                    <div class="widget-check-box">
                                        <input type="checkbox" id="20825" />
                                        <label for="20825">SChocolate Moulds (11) </label>
                                    </div>
                                </div>
                                ...
                                <div class="widget-inner">
                                    <div class="widget-check-box">
                                        ...
                                        <label for="20820">Graphic Corner (11)</label>
                                    </div>

                                    <div class="widget-check-box">
                                        <input type="checkbox" id="20821" />
                                        <label for="20821">Studio Design (5) </label>
                                    </div>
                                </div>
                            </form>
                        </div>

                                ...
                                <tr @dblclick="showDetails(item)"
                                    ...
                                    <td style="width: 22%">
                                        <div class="input-group gap-2">
                                            ...
                                            <button @click="changeStatus( item, 'delivery' ) " type="button" v-if="searchBy != 'delivery'" :style="{background: item.status == 'processing' ? 'green' : '' }" class="text-white shadow-none outline-none border-0">Delivery</button>
                                        </div>
                                    </td>
                                </tr>
                            </template>
